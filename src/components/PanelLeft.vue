		...
		<ul class="text-sm border-b-2 border-gray-400">
			...
			<li class="items-center py-2 pl-4 mb-1 hover:bg-gray-400">
				<div class="flex items-center text-gray-800">
					...
					<a class="ml-2" href="#">Friendly Form</a>
				</div>
			</li>
			<li class="items-center py-2 pl-4 mb-1 hover:bg-gray-400">
				<div class="flex items-center text-gray-800">
					...
					<a class="ml-2" href="#">Friendly Submissions</a>
				</div>
			</li>
			<li class="items-center py-2 pl-4 mb-1 hover:bg-gray-400">
				<div class="flex items-center text-gray-800">
					...
					<a class="ml-2" href="#">Properties</a>
				</div>
			</li>
			<li class="items-center py-2 pl-4 mb-1 hover:bg-gray-400">
				<div class="flex items-center text-gray-800">
		...
		<ul class="text-sm">
			<li class="items-center py-2 pl-4 mb-1 hover:bg-gray-400">
				<div class="flex items-center text-gray-800">
					...
					<a class="ml-2" href="#">Property Flag</a>
				</div>
			</li>
			<li class="items-center py-2 pl-4 mb-1 hover:bg-gray-400">
				<div class="flex items-center text-gray-800">
					...
					<a class="ml-2" href="#">CAD Websites</a>
				</div>
			</li>
			<li class="items-center py-2 pl-4 mb-1 hover:bg-gray-400">
				<div class="flex items-center text-gray-800">
			...
			<li class="items-center py-2 pl-4 mb-1 hover:bg-gray-400">
				<div class="flex items-center text-gray-800">
					...
					<a class="ml-2" href="#">Resolute PTS Website</a>
				</div>
			</li>
			<li class="items-center py-2 pl-4 mb-1 hover:bg-gray-400">
				<div class="flex items-center text-gray-800">
